...
<html lang="zxx">
<head>
<title>Pago OXXO - Pateleria</title>
<!-- custom-theme -->
		...
		<div class="center-container inner-container">
			<div class="w3_agile_header">
						<div class="w3_agileits_logo">
							<h1><a href="home_g.html">Pasteleria & Panaderia<span>Felicidad a cada mordida</span></a></h1>
							</div>
							<div class="w3_menu">
								...
								<nav class="navbar navbar-default">
									...
									<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
										<ul class="nav navbar-nav">
											...
											<li><a href="buynow.html">Comprar ahora!</a></li>
											...
											<!--
											<li><a href="contact.html">Servicio </a></li>
				...
				<!-- banner-text -->
			<h2 class="inner-heading-agileits-w3layouts">Metodo de pago OXXO</h2>
...
<!-- //banner -->
	...
	<div class="contact-top-agileinfo">
		<div class="container">
			...
			<div >
				<h1></h1>
				<p><IMG SRC="https://upload.wikimedia.org/wikipedia/commons/thumb/6/66/Oxxo_Logo.svg/512px-Oxxo_Logo.svg.png"></p>
				...
				<div class="customer-info-w3ls">
					...
					<div class="form-group">
                        <button type="submit" class="form-control btn btn-primary submit px-3">Imprimir</button>
                    </div>
...
<div class="footer_bottom section">
	<div class="agileits-w3layouts-footer">
		<div class="container">
			<div class="col-md-4 w3-agile-grid">
				...
				<p>Nuestro equipo de expertos, esta dedicado a ofercte reposteria de la mas alta calidad </p>
				...
				<div class="w3-address">
					<div class="w3-address-grid">
						...
						<div class="w3-address-right">
							<h6>Numero de atencion a clientes</h6>
							<p>7221234567</p>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="w3-address-grid">
						...
						<div class="w3-address-right">
							...
							<p>Correo :<a href="mailto:example@email.com"> admin_pasteleria@example.com</a></p>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="w3-address-grid">
			...
			<div class="col-md-4 footer-right w3-agile-grid">
				...
				<h5>Suscribete !</h5>
				<form action="#" method="post">
					<input type="email" name="Email" placeholder="Compartenos nuestro correo" required="">
	...
	<div class="copyright">
		   <p>© 2023 Daniel Meza Dev. All rights reserved | Design by Daniel Meza</a></p>
	</div>
</div>
<!-- Modal1 -->
