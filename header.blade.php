			...
			<div class="w3_agile_header">
						...
						<div class="w3_agileits_logo">
							...
							<div class="agileits_w3layouts_banner_info">
									...
									<a  href="{{ url('/login') }} "  class="botton-agileits" value="Iniciar sesion"> Iniciar sesion</a>
							...
							<!-- inicio navbar-->
									...
									<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
										<ul class="nav navbar-nav">
											...
											<li><a href="{{ url('/buynow')}}">Compra ahora</a></li>
...
<!-- banner-text -->
							...
							<ul class="rslides callbacks callbacks1" id="slider4">
								<li>
									<div class="agileits-banner-info">
											<h4>Lo mejor para tu evento</h4>
												<h3>Sorprendelos en cada cucharada</h3>
											</div>	
								</li>
								<li>
									<div class="agileits-banner-info">
											<h4>Sonrisas & Placer</h4>
												<h3>Llena tu evento de Sabor y Felicidad!</h3>
											</div>	
								</li>
								<li>
									<div class="agileits-banner-info">
											   <h4>El mejor Regalo</h4>
											   <h3>Sorprende a tus invitados</h3>
											</div>	
								</li>
							</ul>
						</div>
			...
			<div class="w3_agileits_social_media ">
				<ul class="social-icons3">
					<li class="agileinfo_share">Siguenos en </li>
